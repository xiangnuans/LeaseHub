...
export default function StakeTravel() {
  return (
    <div className="relative mb-1 h-[800px] content-center self-stretch lg:h-auto md:h-auto">
      ...
      <div className="container-xs absolute bottom-0 left-0 right-0 top-0 my-auto flex h-max justify-center px-10 lg:px-5 md:px-5">
        <div className="flex w-full flex-col gap-5">
          ...
          <div className="ml-[66px] mr-[120px] flex flex-col items-center md:mx-0">
            ...
            <div className="mt-4 flex flex-col  items-center">
              ...
              <Text
                size="textxl"
                as="p"
                className="mr-[62px] self-end text-[20px] font-normal text-white-a700 lg:text-[17px] md:mr-0"
              >
                SOL
              </Text>
            </div>
